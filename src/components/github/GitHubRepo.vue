<template lang="pug">
  a.repo-item(:href="repo.html_url")
    div.repo-content
      div.repo-title
        span.text-holder-wrapper(v-text="repo.name")
      div.repo-homepage(v-if="repo.homepage") Project site: 
        a(:href="repo.homepage" v-text="repo.homepage")
      div.repo-desc
        span.text-holder-wrapper(v-text="repo.description")
      div.repo-info
        div.repo-language
          span.text-holder-wrapper(v-text="repo.language")
        div.repo-stats
          svg.octicon.octicon-eye(aria-hidden="true" class="" height="16" version="1.1" viewBox="0 0 16 16" width="16")
          ...
          p(v-text="repo.watchers_count")
          svg.octicon.octicon-star(aria-hidden="true" class="" height="16" version="1.1" viewBox="0 0 14 16" width="14")
            path(fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z")
          p(v-text="repo.stargazers_count")
          svg.octicon.octicon-repo-forked(aria-hidden="true" class="" height="16" version="1.1" viewBox="0 0 10 16" width="10")
